  ...
  try:
    for folder in os.listdir(f'{basePath}/data'):
      ...
      if (checkIfResponsesExist(f'{dataFolder}/{folder}', 'L') == True):
        print(f'Response already exists in {dataFolder}/{folder}... Skipping to next directory for checking.')
        continue
      else:
        print(f'No Response preparing for a call...')
...
async def loopAllWordsAndCreateFiles():
  ...
  for word in word_list:
    ...
    if (os.path.exists(f'{dataFolder}/{word}')):
      print(f'This directory already exist - {word}... Skipping to the next word.')
      continue
    else:
      print(f'Creating a new directory... {word}')
